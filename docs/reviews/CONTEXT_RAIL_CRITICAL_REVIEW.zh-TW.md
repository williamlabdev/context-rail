...
- AI Builder Cup 首頁目前列 prototype 截止 10/18；FAQ 的部分組隊日期仍為 10/4，與首頁 10/11 不一致。日期狀態維持 UNKNOWN；G0 必須以實際提交入口或主辦方確認，確認前以最早可能日期作保守準備。（2026-09-26 更新：重新查核官網與 FAQ，10/4 已不再出現，FAQ 僅列組隊截止 10/11；官方日期確認為原型提交截止 10/18、報名截止 10/11、評估階段 10/19 至 11/6，時區仍未列出。）
...
已修正於計畫 19 節：列出 150／200／250／300 人時情境、A／B 工時與 G1 至 G5 出口。基準每人 125 人時，含 30 人時風險緩衝。實際開發開始後每週以工時和通過里程碑重估，不依靠「有 AI 所以一定更快」作估算。比賽日期另設 G0 確認 gate；10/18 目前只是工程窗口假設，不能覆蓋尚未解除的 10/4／10/11 日期衝突。（2026-09-26 更新：官網重新查核，日期衝突已解除——原型提交截止確認為 2026-10-18，報名截止為 2026-10-11，評估階段為 2026-10-19 至 2026-11-06；時區仍未列出。）
...
- **日期衝突：CONFIRMED／🔴**。Project Plan 仍記錄 prototype 10/18、首頁組隊 10/11、FAQ 10/4，且時區未明示。文件現在把日期狀態標為 UNKNOWN，新增 G0 確認 gate，並要求確認前採最早可能日期作保守準備。（2026-09-26 更新：官網與 FAQ 重新查核，10/4 已不再出現；官方日期確認為原型提交截止 2026-10-18、報名截止 2026-10-11、評估階段 2026-10-19 至 2026-11-06，時區仍未列出，此項狀態改為 RESOLVED／✓。）
