...
**Status**: Draft; pending `DR-002` human decision
...
- `DR-002` must be accepted by a human before implementation files are changed. Local planning artifacts do not imply staging authorization.
