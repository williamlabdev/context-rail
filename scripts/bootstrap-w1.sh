...
BRANCH="${BRANCH:-feat/vs-005-candidate-gate}"
...
git push -u origin develop feat/cloud-run-baseline feat/vs-003-topology feat/vs-004-decision-pack feat/vs-005-candidate-gate 2>&1 | tail -6
